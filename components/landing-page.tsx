...
export default function LandingPage() {
  return (
    <main className="min-h-[calc(100vh-4rem)] bg-gradient-to-br from-blue-50 via-sky-50 to-slate-50 py-12 px-4">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-10">
          <div className="inline-block animate-bounce-slow mb-4">
            <div className="bg-gradient-to-r from-blue-600 to-sky-600 text-white px-4 py-1 rounded-full text-sm font-medium">
              Comprehensive IT Equipment Valuation
            </div>
          </div>
          <h1 className="text-4xl font-bold tracking-tight bg-gradient-to-r from-blue-600 via-sky-600 to-green-500 bg-clip-text text-transparent sm:text-5xl mb-3">
        ...
        <div className="mt-16">
          <h2 className="text-2xl font-semibold text-blue-700 mb-6 text-center">Supported Device Categories</h2>
          <div className="grid md:grid-cols-3 lg:grid-cols-7 gap-4 max-w-4xl mx-auto">
            ...
            <div className="bg-white/80 backdrop-blur-sm p-4 rounded-xl shadow-sm hover:shadow-md transition-all text-center">
              <div className="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-3">
                <ScreenShare className="h-6 w-6 text-green-600" />
              </div>
        ...
        <div className="mt-16 text-center">
          <h2 className="text-2xl font-semibold text-blue-700 mb-4">Why Use Our Calculator?</h2>
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            ...
            <div className="bg-white/80 backdrop-blur-sm p-6 rounded-xl shadow-sm hover:shadow-md transition-all">
              <div className="w-12 h-12 bg-sky-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-sky-600 text-xl font-bold">2</span>
              </div>
